...
<head>
    ...
    <title>Tambah Menu - MyCanteen</title>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nm_menu" required
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi"
                              class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-pink-300"></textarea>
                </div>
